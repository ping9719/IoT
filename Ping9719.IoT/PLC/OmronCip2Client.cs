...
namespace Ping9719.IoT.PLC
{
    ...
    /// 欧姆龙客户端（Cip协议）
    /// </summary>
    public class OmronCip2Client : IIoT
    {
        /// <summary>
        /// 插槽
        /// </summary>
        ...
        public OmronCip2Client(ClientBase client, byte slot = 0, int timeout = 1500)
        {
            Client = client;
        ...
        public OmronCip2Client(string ip, int port = 44818, byte slot = 0, int timeout = 1500) : this(new TcpClient(ip, port), slot, timeout) { }
