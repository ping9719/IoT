        ...
        public IoTResult<T> Read<T>()
        {
            ...
            try
            {
                ...
                if (typeof(T) == typeof(byte[]))
                    ...
                    result.Value = (T)(object)BitConverter.ToInt16(byte1.EndianToNet(format), 0);
                else if (typeof(T) == typeof(UInt16))
                    result.Value = (T)(object)BitConverter.ToUInt16(byte1.EndianToNet(format), 0);
                else if (typeof(T) == typeof(Int32))
                    result.Value = (T)(object)BitConverter.ToInt32(byte1.EndianToNet(format), 0);
                else if (typeof(T) == typeof(UInt32))
                    result.Value = (T)(object)BitConverter.ToUInt32(byte1.EndianToNet(format), 0);
