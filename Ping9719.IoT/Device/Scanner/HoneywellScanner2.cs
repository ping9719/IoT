...
namespace Ping9719.IoT.Device.Scanner
{
    ...
    /// </summary>
    public class HoneywellScanner2 : SerialPortBase, IScannerBase
    {
        ...
        /// 使用串口的方式
        /// </summary>
        public HoneywellScanner2(string portName, int baudRate = 115200, Parity parity = Parity.None, int dataBits = 8, StopBits stopBits = StopBits.One)
        {
            if (serialPort == null)
